...
const i18n = {
  ru: {
    ...
    'work.yandex.desc': 'Ребрендинг Алабуги, анимация логотипа, рекламные креативы, AI-ролики и локализация YouTube — видео в полном качестве.',
  ...
  en: {
    ...
    'work.yandex.desc': 'Alabuga rebranding, logo animation, ad creatives, AI videos and YouTube localization — full-quality video files.',
    'work.yandex.sub': 'Yandex Disk ↗',
    'work.envato.title': 'JustaMotion',
