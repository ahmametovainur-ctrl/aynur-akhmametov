...
const i18n = {
  ru: {
    ...
    'work.yandex.item1': 'Ребрендинг Алабуги',
    'work.yandex.item2': 'Анимация логотипа',
    'work.yandex.item3': 'Рекламные креативы',
    'work.yandex.item4': 'AI-ролики',
    'work.yandex.item5': 'Локализация YouTube',
    'work.yandex.desc': 'Видео в полном качестве — смотреть на Yandex Disk.',
    'work.yandex.sub': 'Yandex Disk ↗',
    'work.envato.title': 'JustaMotion',
    'work.envato.desc': '155+ коммерческих шаблонов и элементов для Reels, TikTok и вертикальных форматов.',
  ...
  en: {
    ...
    'work.yandex.item1': 'Alabuga rebranding',
    'work.yandex.item2': 'Logo animation',
    'work.yandex.item3': 'Ad creatives',
    'work.yandex.item4': 'AI videos',
    'work.yandex.item5': 'YouTube localization',
    'work.yandex.desc': 'Full-quality video files on Yandex Disk.',
    'work.yandex.sub': 'Yandex Disk ↗',
    'work.envato.title': 'JustaMotion',
    'work.envato.desc': '155+ commercial templates and elements for Reels, TikTok and vertical formats.',
    'work.envato.sub': 'Envato ↗',
